...
<html>
  ...
  <body>
    ...
    <img style="height: 700px;width: 100%;" alt="" src="img/ambul.gif">
        ...
        <form action="action2.jsp" method="post" >
               ...
               <div class="form-container">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" name="age" class="form-control" id="inputEmail" aria-describedby="emailHelp" placeholder="Enter email">
                        </div>
                        <div class="form-group">
                        <label for="inputEmail">Police Name</label>
                        <input type="text" name="policename" class="form-control" id="inputEmail" aria-describedby="emailHelp" placeholder="Enter email">
                        </div>
                        <div class="form-group">
                        <label for="inputEmail">position</label>
                        <input type="text" name="position" class="form-control" id="inputEmail" aria-describedby="emailHelp" placeholder="Enter email">
                        </div>
                        
               </div>

               <h2 class="form-heading">Incident Details</h2>
