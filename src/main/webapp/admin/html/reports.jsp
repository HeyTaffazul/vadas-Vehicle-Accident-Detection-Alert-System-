...
<main class="table">
        <section class="table__header">
            <h1>Expansive Report's || Dashboard</h1>
            ...
            <table>
                <thead>
                    <tr>
                        ...
                        <th> Day's <span class="icon-arrow">&UpArrow;</span></th>
                        <th> Invoice <span class="icon-arrow">&UpArrow;</span></th>
                ...
                <tbody>
                    ...
                    <tr>
                        <td> 2 </td>
                        <td><img src="img/Jeet Saru.jpg" alt=""> Jeet Saru </td>
                        <td> Kathmandu </td>
                        <td> 27 Aug, 2023 </td>
                        <td>
                    ...
                    <tr>
                        ...
                        <td> 14 Mar, 2023 </td>
                        <td>
                            <p class="status shipped">Success</p>
                        </td>
                    ...
                    <tr>
                        <td> 5</td>
                        <td><img src="img/Sarita Limbu.jpg" alt=""> Sarita Limbu </td>
                        <td> Paris </td>
                        <td> 23 Apr, 2023 </td>
                        <td>
                    ...
                    <tr>
                        <td> 6</td>
                        <td><img src="img/Alex Gonley.jpg" alt=""> Alex Gonley </td>
                        <td> London </td>
                        <td> 23 Apr, 2023 </td>
                        <td>
                            <p class="status cancelled">Cancelled</p>
                    ...
                    <tr>
                        <td> 7</td>
                        <td><img src="img/Alson GC.jpg" alt=""> Jeet Saru </td>
                        <td> New York </td>
                        <td> 20 May, 2023 </td>
                        <td>
                            <p class="status delivered">Success</p>
                    ...
                    <tr>
                        <td> 8</td>
                        <td><img src="img/Sarita Limbu.jpg" alt=""> Aayat Ali Khan </td>
                        <td> Islamabad </td>
                        <td> 30 Feb, 2023 </td>
                        <td>
                            <p class="status pending">Pending</p>
                    ...
                    <tr>
                        <td> 9</td>
                        <td><img src="img/Alex Gonley.jpg" alt=""> Alson GC </td>
                        <td> Dhaka </td>
                        <td> 22 Dec, 2023 </td>
                        <td>
                            <p class="status cancelled">Cancelled</p>
