        ...
        <div class="authentication-inner">
          ...
          <div style=" background: linear-gradient(to right, #00093c, #2d0b00);" class="card">
            <div class="card-body">
              ...
              <p style="color:#fff; margin-left: 80px;" class="mb-4">Sign-in to for User</p>
              ...
              <form id="formAuthentication" class="mb-3" action="action2.jsp" method="post">
                ...
                <div class="mb-3">
                  <button class="btn btn-primary d-grid w-100" type="submit" name="btn" value="ulogin">Sign in</button>
                </div>
              </form>
